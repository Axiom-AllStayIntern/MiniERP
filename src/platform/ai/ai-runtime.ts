 ...
 * `$lib/server/services/ai-agent:callAiJsonWithSource` helper — that helper
 ...
 * abstraction listed in doc 05 §30.3 lands later; until then this file is
 * the call site.
 */
 ...
 * output we don't retry beyond what `callAiJsonWithSource` already does — we
